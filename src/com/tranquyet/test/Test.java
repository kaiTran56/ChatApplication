...
public class Test extends JFrame {
	...
	public Test() {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
						.addComponent(tabbedPane, GroupLayout.DEFAULT_SIZE, 550, Short.MAX_VALUE).addContainerGap()));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
						.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(tabbedPane,
	...
	public void displayChatPublic() {
		...
		gl_panelChatPublic.setHorizontalGroup(gl_panelChatPublic.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelChatPublic.createSequentialGroup()
						.addGroup(gl_panelChatPublic.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelChatPublic.createSequentialGroup().addGap(14).addComponent(
										textMessageInput, GroupLayout.PREFERRED_SIZE, 341, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_panelChatPublic.createSequentialGroup().addContainerGap().addComponent(
										scrollPane, GroupLayout.PREFERRED_SIZE, 345, GroupLayout.PREFERRED_SIZE)))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_panelChatPublic.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelChatPublic.createParallelGroup(Alignment.LEADING, false)
								...
								.addGroup(gl_panelChatPublic.createSequentialGroup()
										...
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnDisconnect,
		...
		gl_panelChatPublic.setVerticalGroup(gl_panelChatPublic.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panelChatPublic.createSequentialGroup().addGroup(gl_panelChatPublic
						.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelChatPublic.createSequentialGroup().addContainerGap()
								.addComponent(textListUser, GroupLayout.PREFERRED_SIZE, 168, GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(textInputName, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(btnConnectChat, GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE))
						.addGroup(gl_panelChatPublic.createSequentialGroup().addGap(12).addComponent(scrollPane,
								GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE)))
						.addGap(18)
						.addGroup(gl_panelChatPublic.createParallelGroup(Alignment.LEADING).addGroup(gl_panelChatPublic
								.createSequentialGroup()
								.addGroup(gl_panelChatPublic.createParallelGroup(Alignment.LEADING)
										.addComponent(btnSendMessage, GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE)
										.addComponent(btnDisconnect, GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE))
								.addGap(11))
								.addGroup(gl_panelChatPublic.createSequentialGroup()
	...
	public void displayPrivateChat() {
		...
		listUser.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				lblNameUser.setText(null);
				lblNameUser.setText(value);

			}
		});

		lblNameUser = new JLabel("User: ");
		lblNameUser.setFont(new Font("Tahoma", Font.BOLD, 14));
				...
				.addGroup(gl_panelChatPrivate.createSequentialGroup().addGap(10).addGroup(gl_panelChatPrivate
						...
						.addGroup(gl_panelChatPrivate.createSequentialGroup()
								...
								.addGroup(gl_panelChatPrivate.createParallelGroup(Alignment.LEADING, false)
										.addGroup(gl_panelChatPrivate.createSequentialGroup().addGap(13)
												.addComponent(btnQuit, GroupLayout.PREFERRED_SIZE, 119,
														GroupLayout.PREFERRED_SIZE)
												.addGap(10))
										.addGroup(gl_panelChatPrivate.createSequentialGroup().addGap(13).addComponent(
												listUser, GroupLayout.PREFERRED_SIZE, 119, GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_panelChatPrivate.createSequentialGroup()
												.addPreferredGap(ComponentPlacement.UNRELATED)
												.addComponent(lblNewLabel, GroupLayout.PREFERRED_SIZE, 45,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblUserName,
														GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
														Short.MAX_VALUE)))
								.addContainerGap())
						.addGroup(gl_panelChatPrivate.createSequentialGroup().addGroup(gl_panelChatPrivate
								.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelChatPrivate.createSequentialGroup().addGap(239)
										.addComponent(btnIconSmile, GroupLayout.PREFERRED_SIZE, 89,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnIconLike))
								.addGroup(gl_panelChatPrivate.createSequentialGroup().addGap(10)
										.addComponent(lblNameUser, GroupLayout.PREFERRED_SIZE, 59,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(textInputMessage_1,
		...
		gl_panelChatPrivate.setVerticalGroup(gl_panelChatPrivate.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelChatPrivate.createSequentialGroup().addGap(10).addGroup(gl_panelChatPrivate
						...
						.addGroup(gl_panelChatPrivate.createSequentialGroup()
								...
								.addGroup(gl_panelChatPrivate.createParallelGroup(Alignment.BASELINE)
										...
										.addComponent(lblUserName, GroupLayout.PREFERRED_SIZE, 29,
												GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(listUser, GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE)
								.addGap(32).addComponent(btnQuit, GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
								.addGap(18))
						.addGroup(gl_panelChatPrivate.createSequentialGroup()
						...
						.addGroup(gl_panelChatPrivate.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panelChatPrivate.createParallelGroup(Alignment.BASELINE)
										.addComponent(textInputMessage_1, GroupLayout.PREFERRED_SIZE, 52,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lblNameUser, GroupLayout.PREFERRED_SIZE, 48,
												GroupLayout.PREFERRED_SIZE)))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_panelChatPrivate.createParallelGroup(Alignment.BASELINE)
								.addComponent(btnIconLike, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
